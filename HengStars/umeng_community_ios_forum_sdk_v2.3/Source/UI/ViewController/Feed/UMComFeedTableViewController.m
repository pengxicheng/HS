...
@interface UMComFeedTableViewController ()<NSFetchedResultsControllerDelegate,UITextFieldDelegate,UMComClickActionDelegate,UMComScrollViewDelegate,UMComFeedOperationFinishDelegate> {
...
{
    __weak typeof(self) weakSelf = self;
    [[UMComAction action] performActionAfterLogin:user viewController:self completion:^(id responseObject, NSError *error) {
        if (!error) {
...
- (void)customObj:(id)obj clickOnLocationText:(UMComFeed *)feed
{
    ...
    [[UMComAction action] performActionAfterLogin:nil viewController:self completion:^(id responseObject, NSError *error) {
        ...
        //2016.4.18
        nearbyFeedViewController.hidesBottomBarWhenPushed = YES;
...
- (void)customObj:(id)obj clickOnForward:(UMComFeed *)feed
{
    ...
    __weak typeof(self) weakSelf = self;
    [[UMComAction action] performActionAfterLogin:feed viewController:self completion:^(id responseObject, NSError *error) {
        if (!error) {
...
- (void)customObj:(id)obj clickOnComment:(UMComComment *)comment feed:(UMComFeed *)feed
{
    ...
    [[UMComAction action] performActionAfterLogin:nil viewController:self completion:^(id responseObject, NSError *error) {
        if (!error) {
            ...
            feedDetailViewController.feedOperationFinishDelegate = weakSelf;
            //2016.4.18
            feedDetailViewController.hidesBottomBarWhenPushed = YES;
