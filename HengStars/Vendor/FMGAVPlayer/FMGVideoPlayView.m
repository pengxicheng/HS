...
-(void)ShowNavigationVar:(BOOL)isShow
{
    self.isShowNavigationBar = isShow;
...
- (IBAction)playOrPause:(UIButton *)sender {
    ...
    //设置导航栏
    [self ShowNavigationVar:!self.isShowNavigationBar];
    [_delegate videoplayViewShowNavigationBar:self.isShowNavigationBar];
